            ...
            for (int x = pos.x - clusterRadius[pos]; x < pos.x + clusterRadius[pos]; x ++)
            {
                for (int y = pos.y - clusterRadius[pos]; y < pos.y + clusterRadius[pos]; y++)
                {
                    ...
                    else if (noisef != null)
                    {
                        ...
                        if (val < 1 / 6f)
                            t_map[x + y * b_map.GetLength(0)] = TileID.Crystal01;
                        else if (val < 2 / 6f)
                            t_map[x + y * b_map.GetLength(0)] = TileID.Crystal02;
                        else if (val < 3 / 6f)
                            t_map[x + y * b_map.GetLength(0)] = TileID.Crystal03;
                        else if (val < 4 / 6f)
                            t_map[x + y * b_map.GetLength(0)] = TileID.Crystal04;
                        else if (val < 5 / 6f)
                            t_map[x + y * b_map.GetLength(0)] = TileID.Crystal05;
                        else
                            t_map[x + y * b_map.GetLength(0)] = TileID.Crystal06;
                    }
                }
            }
        }
