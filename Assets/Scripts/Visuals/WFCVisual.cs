...
public class WFCVisual : MonoBehaviour
{
    ...
    #endregion
    public void ChangeSizeX(int new_size) => CropTextureSize(new Vector2Int(new_size, size.y));
    public void ChangeSizeY(int new_size) => CropTextureSize(new Vector2Int(size.x, new_size));
}